...
import { Mail, Lock, Eye, EyeOff, ShoppingBag, User } from 'lucide-react';
...
export default function Register() {
  ...
  return (
    <motion.div 
      ...
      className="bg-white w-full max-w-[420px] rounded-[20px] sm:shadow-lg sm:border sm:border-gray-100 overflow-hidden my-8"
    >
      <div className="p-8 sm:p-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="mt-1 text-sm text-gray-500 font-medium text-center">
            Join ShopNest to start selling
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  {...register('firstName')}
                  className={`appearance-none block w-full pl-10 pr-3 py-2.5 border ${errors.firstName ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#1e3a8a] focus:ring-[#1e3a8a]'} rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-1 sm:text-sm transition-colors`}
                  placeholder="John"
                />
              </div>
              <AnimatePresence>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  {...register('lastName')}
                  className={`appearance-none block w-full pl-10 pr-3 py-2.5 border ${errors.lastName ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#1e3a8a] focus:ring-[#1e3a8a]'} rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-1 sm:text-sm transition-colors`}
                  placeholder="Doe"
                />
              </div>
              <AnimatePresence>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                type={showPassword ? "text" : "password"}
                placeholder="••••••••"
                className={`appearance-none block w-full pl-10 pr-3 py-2.5 border ${errors.confirmPassword ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#1e3a8a] focus:ring-[#1e3a8a]'} rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-1 sm:text-sm transition-colors`}
              />
            </div>
            <AnimatePresence>
            ...
            <div className="flex items-start pt-1">
              ...
              <div className="ml-2.5 text-sm">
                <label className="text-gray-700 font-medium">
                  I agree to the{' '}
                  <a href="#" className="text-[#1e3a8a] hover:text-[#172554] transition-colors">Terms of Service</a>
                  {' '}and{' '}
                  <a href="#" className="text-[#1e3a8a] hover:text-[#172554] transition-colors">Privacy Policy</a>
                </label>
              </div>
            </div>
            <AnimatePresence>
        ...
        <button 
          ...
          className="flex items-center justify-center w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-bold text-gray-700 hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1e3a8a]"
        >
        ...
        <div className="mt-8 text-center text-sm">
          ...
          <Link to="/login" className="font-semibold text-[#1e3a8a] hover:text-[#172554] transition-colors">
            Sign in
          </Link>
        </div>
      </div>
